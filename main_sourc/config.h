...
#define FFMPEG_CONFIGURATION "--target-os=darwin --arch=x86_64 --cc='xcrun -sdk iphonesimulator clang' --enable-cross-compile --disable-debug --disable-programs --disable-doc --enable-pic --disable-iconv --disable-asm --enable-small --disable-ffserver --enable-gpl --enable-libx264 --enable-avresample --extra-cflags='-arch x86_64 -mios-simulator-version-min=7.0 -I/Users/huiti123/Desktop/testfolder/ffmpeg3.2/FFmpeg-iOS-build-script/fat-x264/include' --extra-ldflags='-arch x86_64 -mios-simulator-version-min=7.0 -L/Users/huiti123/Desktop/testfolder/ffmpeg3.2/FFmpeg-iOS-build-script/fat-x264/lib' --prefix=/Users/huiti123/Desktop/testfolder/ffmpeg3.2/FFmpeg-iOS-build-script/thin/x86_64"
